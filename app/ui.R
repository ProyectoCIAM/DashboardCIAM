  ...
  tabItems(
    ...
    ############   TABS  DASHBOARD 3
     ...
     tabItem("ucanalizacion", h2("Utilidad de la canalización"),
      fluidRow(
        box(title = "¿Fue canalizada/o por parte de CIAM a alguna otra institución?", width = 4, height = "400px", header = TRUE, 
          plotlyOutput("canalizado", height = "320px")),
        box(title = "¿A cuál institución?", width = 8, height = "400px", header = TRUE, 
          plotlyOutput("frecInstanciasCanalizadas", height = "320px")),
